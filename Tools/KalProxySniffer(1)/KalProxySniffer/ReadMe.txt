========================================================================
    KONSOLENANWENDUNG: KalProxySniffer-Projektübersicht
========================================================================

Diese KalProxySniffer-Anwendung wurde vom Anwendungs-Assistenten
für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien,
aus denen Ihre KalProxySniffer–Anwendung besteht.


KalProxySniffer.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen "KalProxySniffer.pch" und eine 
