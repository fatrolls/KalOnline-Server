...
GID5=".$_POST['gid5'].",GID6=".$_POST['gid6'].",GID7=".$_POST['gid7'].",GID8=".$_POST['gid8']." WHERE GID1='$gid'", $cid);
		echo "UPDATE GuildAlliance SET GID1=".$_POST['gid1'].",GID2=".$_POST['gid2'].",GID3=".$_POST['gid3'].",GID4=".$_POST['gid4'].",
GID5=".$_POST['gid5'].",GID6=".$_POST['gid6'].",GID7=".$_POST['gid7'].",GID8=".$_POST['gid8']." WHERE GID1='$gid'";
//,Date=".time()."
	} else {
...
//if (
	$gids = mssql_fetch_row($qr);//) { //$gid0-7
...
<tr><td>GID1</td><td>".$gidn[$gid]."<input type='hidden' name='gid1' value='$gid'></td></tr>\n";
	for ($i=2; $i<9; $i++) {
		echo "<tr><td>GID$i</td><td><select name='gid$i' ><option value='0'>-</option>\n";
		foreach ($gidn as $id => $name) {
