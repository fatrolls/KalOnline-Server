...
namespace KalServer
{
    /* Defines a small set of attributes for a player that is used inside
     * the player-list needed by ServerPackets.ServerUserInfo   */
    public class PlayerListItem
    {
        ...
        public byte bStrength;
        public byte bHealth;
        public byte bIntelli;
        public byte bWisdom;
        public byte bAgility;

        public List<ushort> lstItems;
    }
}
