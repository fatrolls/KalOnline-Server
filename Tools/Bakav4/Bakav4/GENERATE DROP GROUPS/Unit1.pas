...
type tmoney = record
 dice:word;
 item:word;
 prefix:word; //or how much.. at money.
end;
var i:integer;
var money:tmoney;
var fil:file;
begin
 ...
 //copy..
 memo1.Text:=stringreplace(memo1.Text,'(group (index ',#13#10+'!INDEX'+#13#10,[rfReplaceAll, rfIgnoreCase]);
 memo1.Text:=stringreplace(memo1.Text,'(money (',#13#10+'!MONEY'+#13#10,[rfReplaceAll, rfIgnoreCase]);
 memo1.Text:=stringreplace(memo1.Text,'(item (',#13#10+'!ITEM'+#13#10,[rfReplaceAll, rfIgnoreCase]);
 ...
 memo1.Text:=stringreplace(memo1.Text,'(',#13#10+'!ITEM'+#13#10,[rfReplaceAll, rfIgnoreCase]); //yeah away with )
 memo1.Text:=stringreplace(memo1.Text,'!END '+#13#10+'!ITEM'+#13#10+'index','!END'+#13#10+'!INDEX'+#13#10,[rfReplaceAll, rfIgnoreCase]); //yeah away with )
 ...
 repeat
  ...
  begin
   ...
   //assignfiles..
   i:=i+1; //next :P
   assignfile(fil,'C:\DROP['+inttostr(strtoint(stringreplace(memo1.Lines.Strings[i],' ','',[rfReplaceAll, rfIgnoreCase])))+'].db');
   rewrite(fil,1);
  end;
