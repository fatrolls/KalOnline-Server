...
void __thiscall std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::clear(std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> > *this); // idb
...
std::string *__thiscall std::vector<IPAddrMask>::reserve(_DWORD *this, unsigned int a2);
void __thiscall std::vector<IPAddrMask>::push_back(std::vector<CIOSocket::CIOTimer> *this, const CIOSocket::CIOTimer *_Val); // idb
int __thiscall sub_4038C0(void *this);
std::string *__thiscall std::vector<IPAddrMask>::capacity(std::vector<IPAddrMask> *this, char *Str);
...
unsigned int __thiscall std::vector<IPAddrMask>::max_size(std::vector<IPAddrMask> *this, void *a2);
...
void __thiscall std::length_error::length_error(std::length_error *this, const std::length_error *__that, int a3, int *a4);
void __thiscall std::vector<IPAddrMask>::_Destroy(std::vector<CIOSocket::CIOTimer> *this, CIOSocket::CIOTimer *_First, CIOSocket::CIOTimer *_Last); // idb
...
void __thiscall __noreturn std::string::assign(std::string *this);
...
void __thiscall std::logic_error::logic_error(std::logic_error *this, const std::logic_error *that);
void *__thiscall std::string::string(void *this, char *Str);
...
void __thiscall std::vector<IPAddrMask>::_Insert_n(int *this, int a2, unsigned int a3, int *a4);
...
void __thiscall std::string::_Copy(std::string *this, int a2, size_t Size);
...
void __stdcall std::vector<CGameScreenOverlay>::_Ucopy<std::vector<CGameScreenOverlay>::const_iterator>(void *Src, int a2, void *a3);
void __cdecl std::_Destroy_range<IPAddrMask>(CIOSocket::CIOTimer *_First, CIOSocket::CIOTimer *_Last);
...
void __cdecl std::fill<XMessageQueue::XElement *,XMessageQueue::XElement>(XMessageQueue::XTimerElement *_First, XMessageQueue::XTimerElement *_Last, const XMessageQueue::XTimerElement *_Val); // idb
...
void __cdecl std::allocator<IPAddrMask>::construct(IPAddrMask *_Ptr, const IPAddrMask *_Val, void *a3);
void __cdecl std::_Destroy_range<IPAddrMask>(boost::shared_ptr<boost::asio::detail::win_mutex> *_First, boost::shared_ptr<boost::asio::detail::win_mutex> *_Last);
...
XMessageQueue::XTimerElement *__cdecl std::_Copy_backward_opt<XMessageQueue::XTimerElement *,XMessageQueue::XTimerElement *>(XMessageQueue::XTimerElement *_First, XMessageQueue::XTimerElement *_Last, XMessageQueue::XTimerElement *_Dest);
...
void __cdecl std::map<int,std::string>::map<int,std::string>(void *a1, _DWORD *a2);
...
void __thiscall std::vector<IPAddrMask>::vector<IPAddrMask>(std::vector<CIOSocket::CIOTimer> *this); // idb
char __thiscall std::vector<IPAddrMask>::_Buy(std::vector<IPAddrMask> *this, unsigned int _Capacity);
void __thiscall std::map<int,CSocket *>::map<int,CSocket *>(std::map<unsigned long,std::list<_tagGameRoomInfo *> *,std::less<unsigned long>,std::allocator<std::pair<unsigned long const ,std::list<_tagGameRoomInfo *> *> > > *this); // idb
void __thiscall std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>(std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> > *this, const iless *_Parg, const std::allocator<std::pair<char const * const,CItem *> > *_Al); // idb
void __thiscall std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::_Init(std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> > *this); // idb
std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> > *__thiscall std::_Tree_val<std::_Tmap_traits<int,CSocket *,std::less<int>,std::allocator<std::pair<int const,CSocket *>>,0>>::_Tree_val<std::_Tmap_traits<int,CSocket *,std::less<int>,std::allocator<std::pair<int const,CSocket *>>,0>>(std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> > *this, _BYTE *a2, char a3);
CMemory **__thiscall std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::_Buynode(void *this);
...
void __thiscall std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Tidy(std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> > *this, _BYTE *a2, char a3);
...
void __cdecl std::_Construct<std::_Tree_nod<std::_Tmap_traits<int,std::pair<std::string,std::string>,std::less<int>,std::allocator<std::pair<int const,std::pair<std::string,std::string>>>,1>>::_Node *,std::_Tree_nod<std::_Tmap_traits<int,std::pair<std::string,std::string>,std::less<int>,std::allocator<std::pair<int const,std::pair<std::string,std::string>>>,1>>::_Node *>(std::_Tree_nod<std::_Tmap_traits<unsigned long,KMacro::CJobSystem,std::less<unsigned long>,std::allocator<std::pair<unsigned long const ,KMacro::CJobSystem> >,0> >::_Node **_Ptr, std::_Tree_nod<std::_Tmap_traits<unsigned long,KMacro::CJobSystem,std::less<unsigned long>,std::allocator<std::pair<unsigned long const ,KMacro::CJobSystem> >,0> >::_Node *const *_Val); // idb
...
void __thiscall std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::_Tidy(std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> > *this); // idb
...
std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> >::iterator *__thiscall std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::erase(std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> > *this, std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> >::iterator *a2, int a3, char a4);
_DWORD *__thiscall std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::erase(int *this, _DWORD *a2, int a3);
...
void __thiscall std::_Tree<std::_Tmap_traits<char const *,CLogin *,StrCmp,std::allocator<std::pair<char const * const,CLogin *>>,0>>::const_iterator::_Inc(std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> >::const_iterator *this); // idb
void __cdecl std::swap<unsigned char>(char *_Left, char *_Right); // idb
...
unsigned int __stdcall StopThread(void *formal);
...
int __cdecl sendMail_1(void *buf, int len);
...
void __cdecl ImageHelpStackWalk(void *LogFile, void *hThread);
// int cleanup(void); weak
// int cleanup_0(void); weak
void __thiscall CIOSocket::AddIOThread(CIOSpinLock *this);
...
void __thiscall std::vector<CIOSocket::CIOTimer>::_Xlen(std::vector<CIOSocket::CIOTimer> *this, void *a2, int a3, int a4);
...
// void __userpurge std::_Destroy_range<CIOSocket::CIOTimer>(_DWORD *a1@<ecx>, CIOSocket::CIOTimer *_First, CIOSocket::CIOTimer *_Last, std::allocator<CIOSocket::CIOTimer> *_Al, std::_Nonscalar_ptr_iterator_tag __formal);
...
_DWORD *__cdecl std::_Pop_heap_0<std::vector<CIOSocket::CIOTimer>::iterator,CIOSocket::CIOTimer,std::less<CIOSocket::CIOTimer>>(int a1, int a2);
void __cdecl std::_Destroy_range<CSyncPacket::CElement>(CIOSocket::CIOTimer *_First, CIOSocket::CIOTimer *_Last);
void __cdecl std::_Construct<CIOSocket::CIOTimer,CIOSocket::CIOTimer>(CIOSocket::CIOTimer *_Ptr, const CIOSocket::CIOTimer *_Val, int a3);
...
_DWORD *__cdecl std::_Pop_heap<std::vector<CIOSocket::CIOTimer>::iterator,int,CIOSocket::CIOTimer,std::less<CIOSocket::CIOTimer>>(int a1, int a2, int a3, int a4, int a5, int a6);
void __cdecl CIOSocket::CIOTimerInstance::CIOTimerInstance(int a1, int a2, char *a3);
...
void __thiscall std::vector<CSyncPacket::CElement>::_Tidy(std::vector<CIOSocket::CIOTimer> *this); // idb
...
unsigned int __thiscall CRWLock::WriteLock(CMemory *this, void *pblock);
...
void __thiscall CLink::Insert(CScreen *this, unsigned int color, const char *string);
...
void __cdecl CSocket::CSocket(CSocket *pSocket);
...
void __thiscall CSocket::OnRead(CPacket *this, int bSuccess, unsigned int dwTransferred, _OVERLAPPED *lpOverlapped);
...
void __thiscall CSyncPacket::CElement::CElement(CSocket *this, int nIID, int nPID, int nCurEnd);
...
void __thiscall CSyncPacket::CElement::CElement(CSyncPacket::CElement *this, int nIID, int nID1, int nVal1, int a5, char *Src);
...
void __stdcall init_codepage(unsigned int codepage, int nIID, int nVal1, int nVal2, char a5, int nVal3, int a7, int nVal4, int TargetValue, int a10, int nID2);
...
void __thiscall InitCodePage::InitCodePage(CSocket *this, int nId, int nEventCode, char *packet);
void __thiscall operator new[](CSocket *this, int nPlayer, int nCount, const char *info);
...
void __stdcall UnwindUp5_1(int a1, int a2, int a3);
...
void __thiscall CDB::BindCol(CDB *this, __int16 nType, void *pValue, int nLength, int *pnInd);
...
void __thiscall CDB::BindParam(CDB *this, unsigned __int16 ipar, __int16 fParamType, __int16 fCType, __int16 fSqlType, unsigned int cbColDef, __int16 ibScale, void *rgbValue, int cbValueMax, int *pcbValue);
...
_DWORD *CMemoryPool<CCmdPacket>::Alloc();
...
void __thiscall std::vector<CSyncPacket::CElement>::_Insert_n(void *this, tagRECT *a2, unsigned int a3, LONG *a4);
...
void __cdecl std::fill<tagRECT *,tagRECT>(tagRECT *_First, tagRECT *_Last, const tagRECT *_Val); // idb
...
tagRECT *__cdecl std::_Copy_backward_opt<tagRECT *,tagRECT *>(tagRECT *_First, tagRECT *_Last, tagRECT *_Dest);
void __cdecl std::_Destroy_range<tagRECT>(tagRECT *_First, tagRECT *_Last);
void __cdecl std::_Uninit_fill_n<CSyncPacket::CElement *,unsigned int,CSyncPacket::CElement,std::allocator<CSyncPacket::CElement>>(CSyncPacket::CElement *_First, unsigned int _Count, const CSyncPacket::CElement *_Val);
_DWORD *__stdcall std::allocator<CSyncPacket::CElement>::construct(void *a1, int a2);
CSyncPacket::CElement *__cdecl std::_Uninit_copy<CSyncPacket::CElement *,CSyncPacket::CElement *,std::allocator<CSyncPacket::CElement>>(CSyncPacket::CElement *_First, CSyncPacket::CElement *_Last, CSyncPacket::CElement *_Dest);
void __cdecl std::_Construct<tagRECT,tagRECT>(tagRECT *_Ptr, const tagRECT *_Val); // idb
...
void __thiscall std::vector<tagRECT>::_Tidy(std::vector<tagRECT> *this); // idb
char *__thiscall sub_41C320(char *this);
void __thiscall CMemoryPool<CPacket>::CPool::~CPool(void *this);
void CMemoryPool<CBillingPacket>::FreeAll();
BOOL __stdcall CStatus::Update();
__time32_t __stdcall InitRandom();
int __cdecl _Random();
char *__stdcall WritePacket(char *packet, char *va);
...
void __stdcall CDB::Close()
{
  ...
  while ( g_pool )
  {
    ...
    if ( v0 )
      DeathMatch_Wait::`vector deleting destructor'((MRegion *)v0, 1u);
  }
...
int CDB::ExecuteNoData(CDB *this, const char *format, ...)
{
  ...
  SQLSMALLINT v7; // [esp+614h] [ebp-20h] BYREF
  char v8[4]; // [esp+618h] [ebp-1Ch]
  SQLCHAR Sqlstate[4]; // [esp+61Ch] [ebp-18h] BYREF
  va_list ArgList; // [esp+628h] [ebp-Ch]
  SQLINTEGER NativeError; // [esp+62Ch] [ebp-8h] BYREF
  DWORD v12; // [esp+630h] [ebp-4h]
  va_list va; // [esp+644h] [ebp+10h] BYREF
...
int __cdecl CDBConfig::Open()
{
  ...
  lisp::var *v14; // eax
  const char *v15; // eax
  const CIOSocket::CIOTimer *v16; // eax
    ...
    *(_DWORD *)&nPort = CConfig::GetInt(&v28, "Port", 40001);
    ...
    if ( !(unsigned __int8)lisp::var::null(&result) )
    {
      ...
      while ( !(unsigned __int8)lisp::var::null(&result) )
      {
        ...
        v23 = inet_addr(v15);
        v16 = (const CIOSocket::CIOTimer *)unknown_libname_8(v23 & v22, v23);
        std::vector<IPAddrMask>::push_back((std::vector<CIOSocket::CIOTimer> *)CDBConfig::s_vSubNet, v16);
      }
    }
    v18 = 1;
    v30 = -1;
...
void __stdcall CDBConfig::Close()
{
  std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::clear(CDBConfig::s_LanguageMap);
}
...
void *__thiscall std::string::operator=(void *this, char *Str)
{
  return std::vector<IPAddrMask>::capacity(this, Str);
}

//----- (00403610) --------------------------------------------------------
void __thiscall std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::clear(std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> > *this)
{
  void **v1; // eax

  v1 = (void **)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Root((int *)this);
  std::vector<IPAddrMask>::max_size(this, *v1);
  *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Root((int *)this) = *((_DWORD *)this + 1);
  *((_DWORD *)this + 2) = 0;
  *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Lmost(this) = *((_DWORD *)this + 1);
  *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Rmost(this) = *((_DWORD *)this + 1);
}
...
std::_Tree<std::_Tmap_traits<int,CSocket *,std::less<int>,std::allocator<std::pair<int const ,CSocket *> >,0> >::iterator *__thiscall std::_Tree<std::_Tmap_traits<int,CUser *,std::less<int>,std::allocator<std::pair<int const,CUser *>>,0>>::find(std::_Tree<std::_Tmap_traits<int,CSocket *,std::less<int>,std::allocator<std::pair<int const ,CSocket *> >,0> > *this, std::_Tree<std::_Tmap_traits<int,CSocket *,std::less<int>,std::allocator<std::pair<int const ,CSocket *> >,0> >::iterator *result, const int *_Keyval)
{
  ...
  v3 = std::vector<CSyncPacket::CElement>::begin((int *)this, v10);
  if ( (unsigned __int8)unknown_libname_18(v3)
    || (v4 = unknown_libname_17(v12),
        ...
        std::less<int>::operator()(_Keyval, v5)) )
  {
    v7 = std::vector<CSyncPacket::CElement>::begin((int *)this, v9);
  }
  else
  {
    v7 = v12;
...
std::string *__thiscall std::vector<IPAddrMask>::reserve(_DWORD *this, unsigned int a2)
{
  ...
  void **v4; // [esp+Ch] [ebp-2Ch]
  int *v5; // [esp+10h] [ebp-28h]
  std::string *v6; // [esp+14h] [ebp-24h]
  ...
  result = (std::string *)std::vector<XMessageQueue::XElement>::capacity(v6);
  if ( (unsigned int)result < a2 )
  {
    v10 = std::allocator<IPAddrMask>::allocate(a2);
    v12 = 0;
    v5 = (int *)std::vector<CIOSocket::CIOTimer>::end(v6, (int)v8);
    v4 = (void **)std::vector<CSyncPacket::CElement>::begin((int *)v6, v7);
    std::vector<CGameScreenOverlay>::_Ucopy<std::vector<CGameScreenOverlay>::const_iterator>(*v4, *v5, v10);
    v12 = -1;
    v9 = std::vector<XMessageQueue::XElement>::size(v6);
    if ( *((_DWORD *)v6 + 1) )
    {
      std::vector<IPAddrMask>::_Destroy(v6, *((CIOSocket::CIOTimer **)v6 + 1), *((CIOSocket::CIOTimer **)v6 + 2));
      std::allocator<CSyncPacket::CElement>::deallocate(
        *((_DWORD *)v6 + 1),
        (*((_DWORD *)v6 + 3) - *((_DWORD *)v6 + 1)) >> 3);
    }
    *((_DWORD *)v6 + 3) = (char *)v10 + 8 * a2;
    result = v6;
    *((_DWORD *)v6 + 2) = (char *)v10 + 8 * v9;
    *((_DWORD *)v6 + 1) = v10;
  }
  return result;
}
...
//----- (00403850) --------------------------------------------------------
void __thiscall std::vector<IPAddrMask>::push_back(std::vector<CIOSocket::CIOTimer> *this, const CIOSocket::CIOTimer *_Val)
{
  unsigned int v2; // esi
  int *v3; // eax
  ...
  v2 = std::vector<XMessageQueue::XElement>::size(this);
  if ( v2 >= std::vector<XMessageQueue::XElement>::capacity(this) )
  {
    v3 = (int *)std::vector<CIOSocket::CIOTimer>::end(this, (int)v6);
    std::length_error::length_error(this, (const std::length_error *)v5, *v3, (int *)_Val);
  }
  else
  {
    *((_DWORD *)this + 2) = std::vector<XMessageQueue::XElement>::_Ufill(
                              this,
                              *((XMessageQueue::XTimerElement **)this + 2),
                              1u,
                              (const XMessageQueue::XTimerElement *)_Val);
  }
}
...
std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> >::iterator *__thiscall std::_Tree<std::_Tmap_traits<char const *,CLogin *,StrCmp,std::allocator<std::pair<char const * const,CLogin *>>,0>>::lower_bound(std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> > *this, std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> >::iterator *result, const char *const *_Keyval)
{
  ...
  v3 = std::_Tree<std::_Tmap_traits<int,CSocket *,std::less<int>,std::allocator<std::pair<int const,CSocket *>>,0>>::_Lbound(
         this,
         (const int *)_Keyval);
  std::vector<CSyncPacket::CElement>::iterator::iterator(result, (int)v3);
  return result;
}
...
unsigned int __thiscall std::vector<IPAddrMask>::max_size(std::vector<IPAddrMask> *this, void *a2)
{
  ...
  v5 = (int)a2;
  for ( i = (char *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Isnil((int)a2);
        ;
        i = (char *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Isnil(v5) )
  {
    result = *i;
    if ( result )
      break;
    std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Right(v5);
    std::vector<IPAddrMask>::max_size(this);
    v5 = *(_DWORD *)unknown_libname_10(v5);
    std::allocator<std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Node>::destroy(a2);
    std::allocator<CSyncPacket::CElement>::deallocate((int)a2, 1);
    a2 = (void *)v5;
  }
  return result;
}
...
int __thiscall std::vector<IPAddrMask>::max_size(void *this)
{
  return std::allocator<std::pair<char const * const,int>>::max_size();
}
...
void __thiscall std::length_error::length_error(std::length_error *this, const std::length_error *__that, int a3, int *a4)
{
  ...
  if ( std::vector<XMessageQueue::XElement>::size(this) )
  {
    v4 = (const std::vector<CIOSocket::CIOTimer>::const_iterator *)std::vector<CSyncPacket::CElement>::begin(
                                                                     (int *)this,
                                                                     v10);
    v7 = std::vector<IPAddrMask>::iterator::operator-((std::vector<CIOSocket::CIOTimer>::iterator *)&a3, v4);
  }
  else
  {
    v7 = 0;
  ...
  v11 = v7;
  std::vector<IPAddrMask>::_Insert_n((int *)this, a3, 1u, a4);
  v6 = v11;
  v5 = (std::vector<CIOSocket::CIOTimer>::iterator *)std::vector<CSyncPacket::CElement>::begin((int *)this, v9);
  std::vector<IPAddrMask>::iterator::operator+(v5, __that, v6);
}

//----- (00403BA0) --------------------------------------------------------
void __thiscall std::vector<IPAddrMask>::_Destroy(std::vector<CIOSocket::CIOTimer> *this, CIOSocket::CIOTimer *_First, CIOSocket::CIOTimer *_Last)
{
  std::_Destroy_range<IPAddrMask>(_First, _Last);
}
...
{
  std::_Uninitialized_fill_n<IPAddrMask *,unsigned int,IPAddrMask,std::allocator<IPAddrMask>>(_Ptr, _Count, (int)_Val);
...
void __thiscall __noreturn std::string::assign(std::string *this)
{
  char v1[28]; // [esp+4h] [ebp-50h] BYREF
  char pExceptionObject[48]; // [esp+20h] [ebp-34h] BYREF
  int v3; // [esp+50h] [ebp-4h]

  std::string::string(v1, "vector<T> too long");
  v3 = 0;
  std::length_error::length_error((std::length_error *)pExceptionObject, (const std::length_error *)v1);
...
void __thiscall std::logic_error::logic_error(std::logic_error *this, const std::logic_error *that)
{
  ...
  *(_DWORD *)this = &std::logic_error::`vftable';
  std::string::string((std::logic_error *)((char *)this + 12), that);
}
...
void __thiscall std::logic_error::logic_error(std::logic_error *this, const std::logic_error *that)
{
  exception::exception((exception *)this, (const struct exception *)that);
  *(_DWORD *)this = &std::logic_error::`vftable';
  std::string::string((std::logic_error *)((char *)this + 12), (const std::logic_error *)((char *)that + 12));
}
// 437954: using guessed type void *std::logic_error::`vftable';
...
void *__thiscall std::string::string(void *this, char *Str)
{
  ...
  std::vector<IPAddrMask>::capacity((std::vector<IPAddrMask> *)v4, Str);
  return v4;
}
...
std::string *__thiscall std::string::assign(std::string *this, void *Src, size_t Size)
{
  ...
  if ( std::string::_Inside(this, (const char *)Src) )
  {
    ...
    result = std::string::assign(this, this, (unsigned int)Src - v3, Size);
  }
  else
  {
...
std::_Tree_nod<std::_Tmap_traits<int,CSocket *,std::less<int>,std::allocator<std::pair<int const ,CSocket *> >,0> >::_Node *__thiscall std::_Tree<std::_Tmap_traits<int,CSocket *,std::less<int>,std::allocator<std::pair<int const,CSocket *>>,0>>::_Lbound(std::_Tree<std::_Tmap_traits<int,CSocket *,std::less<int>,std::allocator<std::pair<int const ,CSocket *> >,0> > *this, const int *_Keyval)
{
  ...
  v5 = *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Root((int *)this);
  v6 = *((_DWORD *)this + 1);
  while ( !*(_BYTE *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Isnil(v5) )
  {
    ...
    if ( std::less<int>::operator()(v2, _Keyval) )
    {
...
void __thiscall std::string::string(std::string *this, const std::string *_Right)
{
  ...
  v2 = (char)this;
  unknown_libname_19(_Right);
  std::_String_val<char>::_String_val<char>(this, v2);
  std::string::_Tidy((int)this, 0, 0);
  std::string::assign(this, _Right, 0, std::string::npos);
}
...
void __thiscall std::vector<IPAddrMask>::_Insert_n(int *this, int a2, unsigned int a3, int *a4)
{
  ...
  XMessageQueue::XTimerElement *v12; // [esp+Ch] [ebp-38h]
  XMessageQueue::XTimerElement *v13; // [esp+10h] [ebp-34h]
  unsigned int v14; // [esp+14h] [ebp-30h]
  int *v15; // [esp+18h] [ebp-2Ch]
  int v16; // [esp+1Ch] [ebp-28h]
  void *v17; // [esp+20h] [ebp-24h]
  void *v18; // [esp+24h] [ebp-20h]
  ...
  v20[0] = *a4;
  v20[1] = v4;
  v19 = std::vector<XMessageQueue::XElement>::capacity((std::vector<XMessageQueue::XTimerElement> *)this);
  if ( a3 )
  {
    v5 = std::vector<XMessageQueue::XElement>::size((std::vector<IPAddrMask> *)v15);
    if ( std::vector<IPAddrMask>::max_size(v15) - v5 < a3 )
      std::string::assign((std::string *)v15);
    v6 = std::vector<XMessageQueue::XElement>::size((std::vector<IPAddrMask> *)v15);
    if ( v19 >= a3 + v6 )
    {
      if ( (v15[2] - a2) >> 3 >= a3 )
      {
        v16 = v15[2];
        v10 = std::vector<IPAddrMask>::_Ucopy<IPAddrMask *>(v15, v16 - 8 * a3, v16, (void *)v15[2]);
        v15[2] = (int)v10;
        std::copy_backward<IPAddrMask *,IPAddrMask *>(
          (CIOSocket::CIOTimer *)a2,
          (CIOSocket::CIOTimer *)(v16 - 8 * a3),
          (CIOSocket::CIOTimer *)v16);
        std::fill<XMessageQueue::XElement *,XMessageQueue::XElement>(
          (XMessageQueue::XTimerElement *)a2,
          (XMessageQueue::XTimerElement *)(a2 + 8 * a3),
          (const XMessageQueue::XTimerElement *)v20);
      }
      else
      {
        std::vector<IPAddrMask>::_Ucopy<IPAddrMask *>(v15, a2, v15[2], (void *)(a2 + 8 * a3));
        v21 = 2;
        std::vector<XMessageQueue::XElement>::_Ufill(
          (std::vector<XMessageQueue::XTimerElement> *)v15,
          (XMessageQueue::XTimerElement *)v15[2],
          a3 - ((v15[2] - a2) >> 3),
          (const XMessageQueue::XTimerElement *)v20);
        v21 = -1;
        v15[2] += 8 * a3;
        std::fill<XMessageQueue::XElement *,XMessageQueue::XElement>(
          (XMessageQueue::XTimerElement *)a2,
          (XMessageQueue::XTimerElement *)(v15[2] - 8 * a3),
          (const XMessageQueue::XTimerElement *)v20);
      }
    }
    else
    {
      v7 = v19 >> 1;
      v8 = std::vector<IPAddrMask>::max_size(v15);
      if ( v8 - v7 >= v19 )
        v14 = v19 + (v19 >> 1);
      else
        v14 = 0;
      v19 = v14;
      v9 = std::vector<XMessageQueue::XElement>::size((std::vector<IPAddrMask> *)v15);
      if ( v19 < a3 + v9 )
        v19 = a3 + std::vector<XMessageQueue::XElement>::size((std::vector<IPAddrMask> *)v15);
      v17 = std::allocator<IPAddrMask>::allocate(v19);
      v18 = v17;
      v21 = 0;
      v13 = (XMessageQueue::XTimerElement *)std::vector<IPAddrMask>::_Ucopy<IPAddrMask *>(v15, v15[1], a2, v17);
      v18 = v13;
      v12 = std::vector<XMessageQueue::XElement>::_Ufill(
              (std::vector<XMessageQueue::XTimerElement> *)v15,
              v13,
              a3,
              (const XMessageQueue::XTimerElement *)v20);
      v18 = v12;
      std::vector<IPAddrMask>::_Ucopy<IPAddrMask *>(v15, a2, v15[2], v12);
      v21 = -1;
      v22 = a3 + std::vector<XMessageQueue::XElement>::size((std::vector<IPAddrMask> *)v15);
      if ( v15[1] )
      {
        std::vector<IPAddrMask>::_Destroy(
          (std::vector<CIOSocket::CIOTimer> *)v15,
          (CIOSocket::CIOTimer *)v15[1],
          (CIOSocket::CIOTimer *)v15[2]);
        std::allocator<CSyncPacket::CElement>::deallocate(v15[1], (v15[3] - v15[1]) >> 3);
      }
      v15[3] = (int)v17 + 8 * v19;
      v15[2] = (int)v17 + 8 * v22;
      v15[1] = (int)v17;
...
std::string *__thiscall std::string::assign(std::string *this, const std::string *_Right, unsigned int _Roff, unsigned int _Count)
{
  ...
  if ( unknown_libname_12(_Right) < _Roff )
    std::_String_base::_Xran((std::_String_base *)this);
  Size = unknown_libname_12(_Right) - _Roff;
  if ( _Count < Size )
    Size = _Count;
  if ( this == _Right )
  {
    std::string::erase(this, Size + _Roff, std::string::npos);
    std::string::erase(this, 0, _Roff);
  }
  else if ( std::string::_Grow(this, Size, 0) )
  {
    v6 = (void *)(_Roff + unknown_libname_11(_Right));
...
void __thiscall std::string::_Tidy(int this, char a2, size_t Size)
{
  ...
  if ( a2 && *(_DWORD *)(this + 24) >= 0x10u )
  {
    Src = *(void **)(this + 4);
    if ( Size )
      std::char_traits<char>::copy((void *)(this + 4), Src, Size);
    std::allocator<CSyncPacket::CElement>::deallocate((int)Src, *(_DWORD *)(this + 24) + 1);
  }
  *(_DWORD *)(this + 24) = 15;
...
std::string *__thiscall std::string::erase(std::string *this, unsigned int _Off, unsigned int _Count)
{
  ...
  if ( _Count )
  {
    ...
    v5 = (void *)(_Count + _Off + unknown_libname_11(this));
    v3 = unknown_libname_11(this);
    sub_4046C0((void *)(_Off + v3), v5, v6);
...
BOOL __thiscall std::string::_Grow(std::string *this, unsigned int _Newsize, bool _Trim)
{
  if ( unknown_libname_24(this) < _Newsize )
  ...
  if ( *((_DWORD *)this + 6) >= _Newsize )
  {
    if ( _Trim && _Newsize < 0x10 )
    {
      if ( _Newsize >= *((_DWORD *)this + 5) )
        std::string::_Tidy((int)this, 1, *((_DWORD *)this + 5));
      else
        std::string::_Tidy((int)this, 1, _Newsize);
    }
    else if ( !_Newsize )
    {
  ...
  {
    std::string::_Copy(this, _Newsize, *((_DWORD *)this + 5));
  }
  return _Newsize != 0;
}
...
{
  *(_DWORD *)result = *(_DWORD *)unknown_libname_14(_Off);
  return result;
}
...
{
  return (unsigned int)_Ptr >= unknown_libname_11(this)
      && *((_DWORD *)this + 5) + unknown_libname_11(this) > (unsigned int)_Ptr;
}
// 404600: using guessed type int __thiscall unknown_libname_11(_DWORD);
...
void __thiscall std::string::_Copy(std::string *this, int a2, size_t Size)
{
  ...
  CMemory **v8; // [esp+10h] [ebp-20h]
  std::string *v9; // [esp+14h] [ebp-1Ch]
  unsigned int v10; // [esp+18h] [ebp-18h]
  void *v11; // [esp+1Ch] [ebp-14h]
  ...
  if ( v3 >= v10 )
  {
    if ( v10 / 3 < *((_DWORD *)v9 + 6) >> 1 )
    {
      v4 = *((_DWORD *)v9 + 6) >> 1;
      v5 = unknown_libname_24(v9);
      if ( *((_DWORD *)v9 + 6) <= (unsigned int)(v5 - v4) )
        v10 = *((_DWORD *)v9 + 6) + (*((_DWORD *)v9 + 6) >> 1);
    }
  }
  else
  {
  ...
  v13 = 0;
  v8 = std::allocator<char>::allocate(v10 + 1);
  v11 = v8;
  v13 = -1;
  if ( Size )
  {
    v6 = (void *)unknown_libname_11(v9);
    std::char_traits<char>::copy(v11, v6, Size);
  }
  std::string::_Tidy((int)v9, 1, 0);
  *((_DWORD *)v9 + 1) = v11;
  *((_DWORD *)v9 + 6) = v10;
  std::string::_Eos(v9, Size);
}
// 404600: using guessed type int __thiscall unknown_libname_11(_DWORD);
// 4048C0: using guessed type int __thiscall unknown_libname_24(_DWORD);
...
void __stdcall std::vector<CGameScreenOverlay>::_Ucopy<std::vector<CGameScreenOverlay>::const_iterator>(void *Src, int a2, void *a3)
{
  std::allocator<IPAddrMask>::construct((IPAddrMask *)Src, (const IPAddrMask *)a2, a3);
}

//----- (00404BA0) --------------------------------------------------------
void __cdecl std::_Destroy_range<IPAddrMask>(CIOSocket::CIOTimer *_First, CIOSocket::CIOTimer *_Last)
{
  unknown_libname_15(&_First, &_Last);
  std::_Destroy_range<IPAddrMask>(
    (boost::shared_ptr<boost::asio::detail::win_mutex> *)_First,
    (boost::shared_ptr<boost::asio::detail::win_mutex> *)_Last);
}
...
//----- (00404C80) --------------------------------------------------------
void __cdecl std::fill<XMessageQueue::XElement *,XMessageQueue::XElement>(XMessageQueue::XTimerElement *_First, XMessageQueue::XTimerElement *_Last, const XMessageQueue::XTimerElement *_Val)
{
  int v3; // ecx
...
{
  unknown_libname_15(&_First, &_Dest);
  return (CIOSocket::CIOTimer *)std::_Copy_backward_opt<XMessageQueue::XTimerElement *,XMessageQueue::XTimerElement *>(
                                  (XMessageQueue::XTimerElement *)_First,
                                  (XMessageQueue::XTimerElement *)_Last,
                                  (XMessageQueue::XTimerElement *)_Dest);
}
// 404F10: using guessed type int __cdecl unknown_libname_15(_DWORD, _DWORD);
...
void __cdecl std::allocator<IPAddrMask>::construct(IPAddrMask *_Ptr, const IPAddrMask *_Val, void *a3)
{
  unknown_libname_15(&_Ptr, &a3);
  std::_Uninit_copy<std::vector<IPAddrMask>::iterator,IPAddrMask *,std::allocator<IPAddrMask>>((int)_Ptr, (int)_Val, a3);
}
// 404F10: using guessed type int __cdecl unknown_libname_15(_DWORD, _DWORD);
...
void __cdecl std::_Destroy_range<IPAddrMask>(boost::shared_ptr<boost::asio::detail::win_mutex> *_First, boost::shared_ptr<boost::asio::detail::win_mutex> *_Last)
{
  while ( _First != _Last )
  {
    std::allocator<std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Node *>::destroy((int)_First);
    _First = (boost::shared_ptr<boost::asio::detail::win_mutex> *)((char *)_First + 8);
  }
}
...
XMessageQueue::XTimerElement *__cdecl std::_Copy_backward_opt<XMessageQueue::XTimerElement *,XMessageQueue::XTimerElement *>(XMessageQueue::XTimerElement *_First, XMessageQueue::XTimerElement *_Last, XMessageQueue::XTimerElement *_Dest)
{
  ...
  while ( _First != _Last )
  {
    _Last = (XMessageQueue::XTimerElement *)((char *)_Last - 8);
    _Dest = (XMessageQueue::XTimerElement *)((char *)_Dest - 8);
    v3 = *((_DWORD *)_Last + 1);
    *(_DWORD *)_Dest = *(_DWORD *)_Last;
    *((_DWORD *)_Dest + 1) = v3;
  }
  return _Dest;
}
...
_DWORD *__stdcall std::allocator<IPAddrMask>::construct(void *a1, int a2)
{
  return std::map<int,std::string>::map<int,std::string>(a1, a2);
}
...
void __thiscall std::string::string(std::string *this)
{
  ...
  v2 = this;
  v1 = this;
  unknown_libname_9(&v1);
  std::_String_val<char>::_String_val<char>(v2, (char)v1);
  std::string::_Tidy((int)v2, 0, 0);
}
// 403F50: using guessed type int __thiscall unknown_libname_9(_DWORD);

//----- (00405160) --------------------------------------------------------
void __thiscall std::vector<IPAddrMask>::vector<IPAddrMask>(std::vector<CIOSocket::CIOTimer> *this)
{
...
char __thiscall std::vector<IPAddrMask>::_Buy(std::vector<IPAddrMask> *this, unsigned int _Capacity)
{
  ...
  *((_DWORD *)this + 1) = std::allocator<IPAddrMask>::allocate(_Capacity);
...
//----- (00405210) --------------------------------------------------------
void __thiscall std::map<int,CSocket *>::map<int,CSocket *>(std::map<unsigned long,std::list<_tagGameRoomInfo *> *,std::less<unsigned long>,std::allocator<std::pair<unsigned long const ,std::list<_tagGameRoomInfo *> *> > > *this)
{
  const std::allocator<std::pair<char const * const,CItem *> > *v1; // eax
  iless v3; // [esp+6h] [ebp-2h] BYREF
  char v4; // [esp+7h] [ebp-1h] BYREF

  v1 = (const std::allocator<std::pair<char const * const,CItem *> > *)unknown_libname_9(&v4);
...
//----- (00405280) --------------------------------------------------------
void __thiscall std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::_Init(std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> > *this)
{
  *((_DWORD *)this + 1) = std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::_Buynode(this);
  *(_BYTE *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Isnil(*((_DWORD *)this + 1)) = 1;
  *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Root((int *)this) = *((_DWORD *)this + 1);
  *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Lmost(this) = *((_DWORD *)this + 1);
  *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Rmost(this) = *((_DWORD *)this + 1);
  *((_DWORD *)this + 2) = 0;
...
void __thiscall std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Tidy(std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> > *this, _BYTE *a2, char a3)
{
  ...
  unknown_libname_19((unsigned __int8)&a3);
}
// 405580: using guessed type _DWORD __stdcall unknown_libname_19(_DWORD);
...
void __cdecl std::_Construct<std::_Tree_nod<std::_Tmap_traits<int,std::pair<std::string,std::string>,std::less<int>,std::allocator<std::pair<int const,std::pair<std::string,std::string>>>,1>>::_Node *,std::_Tree_nod<std::_Tmap_traits<int,std::pair<std::string,std::string>,std::less<int>,std::allocator<std::pair<int const,std::pair<std::string,std::string>>>,1>>::_Node *>(std::_Tree_nod<std::_Tmap_traits<unsigned long,KMacro::CJobSystem,std::less<unsigned long>,std::allocator<std::pair<unsigned long const ,KMacro::CJobSystem> >,0> >::_Node **_Ptr, std::_Tree_nod<std::_Tmap_traits<unsigned long,KMacro::CJobSystem,std::less<unsigned long>,std::allocator<std::pair<unsigned long const ,KMacro::CJobSystem> >,0> >::_Node *const *_Val)
{
  std::_Tree_nod<std::_Tmap_traits<unsigned long,KMacro::CJobSystem,std::less<unsigned long>,std::allocator<std::pair<unsigned long const ,KMacro::CJobSystem> >,0> >::_Node **v2; // [esp+4h] [ebp-4h]

  v2 = (std::_Tree_nod<std::_Tmap_traits<unsigned long,KMacro::CJobSystem,std::less<unsigned long>,std::allocator<std::pair<unsigned long const ,KMacro::CJobSystem> >,0> >::_Node **)operator new(4u, _Ptr);
  if ( v2 )
    *v2 = *_Val;
}
...
int __thiscall std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::~_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>(void *this)
{
  return std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::_Tidy((int *)this);
}

//----- (004056C0) --------------------------------------------------------
void __thiscall std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::_Tidy(std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> > *this)
{
  int *v1; // eax
  int v2; // eax
  int v3; // eax
  ...
  v5 = *(_DWORD *)std::vector<CSyncPacket::CElement>::begin((int *)this, v9);
  ...
  std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::erase(
    ...
    *v1,
    v5);
  v2 = unknown_libname_10(*((_DWORD *)this + 1));
  ...
  v3 = std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Parent(*((_DWORD *)this + 1));
  ...
  v4 = std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Right(*((_DWORD *)this + 1));
  ...
  std::allocator<CSyncPacket::CElement>::deallocate(*((_DWORD *)this + 1), 1);
  *((_DWORD *)this + 1) = 0;
  *((_DWORD *)this + 2) = 0;
}
// 404010: using guessed type _DWORD __cdecl unknown_libname_10(_DWORD);
...
std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> >::iterator *__thiscall std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::begin(std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> > *this, std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> >::iterator *result)
{
  ...
  std::vector<CSyncPacket::CElement>::iterator::iterator(result, *v2);
  return result;
}
...
std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> >::iterator *__thiscall std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::erase(std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> > *this, std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> >::iterator *a2, int a3, char a4)
{
  ...
  if ( (unsigned __int8)unknown_libname_18(v4)
    && (v5 = std::vector<CSyncPacket::CElement>::begin((int *)this, v11), (unsigned __int8)unknown_libname_18(v5)) )
  {
...
_DWORD *__thiscall std::_Tree<std::_Tmap_traits<char const *,CBillingLogin *,StrCmp,std::allocator<std::pair<char const * const,CBillingLogin *>>,0>>::erase(int *this, _DWORD *a2, int a3)
{
  ...
  std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::iterator *v29; // [esp+4h] [ebp-6Ch]
  ...
  std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node *v34; // [esp+54h] [ebp-1Ch]
  std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node *v35; // [esp+58h] [ebp-18h]
  std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node *v36; // [esp+5Ch] [ebp-14h]
  ...
  v35 = (std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node *)v37;
  ...
  {
    v36 = *(std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node **)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Right((int)v35);
  }
  else
  {
    ...
    {
      v36 = *(std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node **)unknown_libname_10(v35);
    }
    else
    {
      v35 = (std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node *)unknown_libname_17(&a3);
      v36 = *(std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node **)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Right((int)v35);
    }
  }
  if ( v35 == v37 )
  {
    v34 = *(std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node **)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Parent((int)v37);
    ...
    if ( *(void **)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Lmost(this) == v37 )
    {
      if ( *(_BYTE *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Isnil((int)v36) )
        ...
        v30 = (std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Max((int)v36);
    ...
    if ( *(void **)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Rmost(this) == v37 )
    {
      if ( *(_BYTE *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Isnil((int)v36) )
        ...
        v29 = std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::iterator::operator++((int)v36);
  ...
  else
  {
    ...
    *(_DWORD *)unknown_libname_10(v35) = *v7;
    if ( v35 == *(std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node **)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Right((int)v37) )
    {
      v34 = v35;
    }
    else
    {
      v34 = *(std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node **)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Parent((int)v35);
      if ( !*(_BYTE *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Isnil((int)v36) )
        *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Parent((int)v36) = v34;
      *(_DWORD *)unknown_libname_10(v34) = v36;
    ...
    *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Parent((int)v35) = *v13;
    ...
    std::swap<unsigned char>(v14, v28);
  }
  if ( *(_BYTE *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Color((int)v37) == 1 )
  {
    while ( 1 )
    {
      if ( v36 == *(std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node **)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Root(this)
...
LABEL_63:
      ...
      if ( v36 == *(std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node **)unknown_libname_10(v34) )
        break;
      v35 = *(std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node **)unknown_libname_10(v34);
...
LABEL_50:
      ...
      v36 = v34;
LABEL_40:
      v34 = *(std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node **)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Parent((int)v36);
    }
    v35 = *(std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node **)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Right((int)v34);
    if ( !*(_BYTE *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Color((int)v35) )
    {
      *(_BYTE *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Color((int)v35) = 1;
      *(_BYTE *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Color((int)v34) = 0;
...
void __thiscall std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Rrotate(std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> > *this, std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node *_Wherenode)
{
  ...
  v10 = *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Right((int)_Wherenode);
  v2 = (_DWORD *)unknown_libname_10(v10);
  *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Right((int)_Wherenode) = *v2;
  v3 = (int *)unknown_libname_10(v10);
  if ( !*(_BYTE *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Isnil(*v3) )
  {
    v4 = (int *)unknown_libname_10(v10);
    *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Parent(*v4) = _Wherenode;
  }
  v5 = (_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Parent((int)_Wherenode);
  *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Parent(v10) = *v5;
  if ( _Wherenode == *(std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node **)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Root((int *)this) )
  {
    *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Root((int *)this) = v10;
  }
  else
  {
    v6 = (_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Parent((int)_Wherenode);
    if ( _Wherenode == *(std::_Tree_nod<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::_Node **)unknown_libname_10(*v6) )
    {
      v7 = (_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Parent((int)_Wherenode);
      *(_DWORD *)unknown_libname_10(*v7) = v10;
    }
    else
    {
      v8 = (int *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Parent((int)_Wherenode);
      *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Right(*v8) = v10;
    }
  }
  *(_DWORD *)unknown_libname_10(v10) = _Wherenode;
  *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Parent((int)_Wherenode) = v10;
}
// 404010: using guessed type _DWORD __cdecl unknown_libname_10(_DWORD);
...
std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const ,std::string > >,0> >::iterator *__cdecl std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::iterator::operator++(int a1)
{
  ...
  while ( 1 )
  {
    v2 = (int *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Right(a1);
...
void *__thiscall std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::const_iterator::operator++(void *this)
{
  std::_Tree<std::_Tmap_traits<char const *,CLogin *,StrCmp,std::allocator<std::pair<char const * const,CLogin *>>,0>>::const_iterator::_Inc((int *)this);
  return this;
}

//----- (004063F0) --------------------------------------------------------
void __thiscall std::_Tree<std::_Tmap_traits<char const *,CLogin *,StrCmp,std::allocator<std::pair<char const * const,CLogin *>>,0>>::const_iterator::_Inc(std::_Tree<std::_Tmap_traits<char const *,CItem *,iless,std::allocator<std::pair<char const * const,CItem *> >,0> >::const_iterator *this)
{
  int *v1; // eax
  int *v2; // eax
  int v4; // [esp+4h] [ebp-4h]

  if ( !*(_BYTE *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Isnil(*(_DWORD *)this) )
  {
    v1 = (int *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Right(*(_DWORD *)this);
    if ( *(_BYTE *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Isnil(*v1) )
    {
      while ( 1 )
      {
        v4 = *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Parent(*(_DWORD *)this);
        if ( *(_BYTE *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Isnil(v4)
          || *(_DWORD *)this != *(_DWORD *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Right(v4) )
        {
          break;
        }
        *(_DWORD *)this = v4;
    ...
    {
      v2 = (int *)std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Right(*(_DWORD *)this);
      *(_DWORD *)this = std::_Tree<std::_Tmap_traits<int,std::string,std::less<int>,std::allocator<std::pair<int const,std::string>>,0>>::_Max(*v2);
    }
  }
}

//----- (004064B0) --------------------------------------------------------
void __cdecl std::swap<unsigned char>(char *_Left, char *_Right)
{
...
int __stdcall WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
  ...
  hHandle = (HANDLE)_beginthreadex(0, 0, StopThread, 0, 0, &ThrdAddr);
...
unsigned int __stdcall StopThread(void *formal)
{
  ...
  std::string *v10; // [esp+8h] [ebp-200h]
  ...
  v10 = GetUniqueName((std::string *)v11);
  v18 = 0;
    ...
    *(_DWORD *)v14 = WSAStartup(0x202u, &WSAData);
    ...
    else if ( CDBConfig::Open() )
    {
      ...
      if ( CDB::Open(v5) )
      {
        ...
        v18 = -1;
        CDB::~CDB(&v13);
        CIOObject::RegisterWait(CDBConfig::s_nNumberOfThreads);
        CServer::Start();
...
std::_String_base *__thiscall sub_406EB0(std::_String_base *this, int a1)
{
  return std::string::append(this, a1, 0, 0xFFFFFFFF);
}
...
std::string *__thiscall std::string::append(std::string *this, const std::string *_Right, unsigned int _Roff, unsigned int _Count)
{
  ...
  if ( unknown_libname_12(_Right) < _Roff )
    std::_String_base::_Xran((std::_String_base *)this);
  v8 = unknown_libname_12(_Right) - _Roff;
  if ( v8 < _Count )
    _Count = v8;
  ...
  if ( _Count )
  {
    v9 = _Count + *((_DWORD *)this + 5);
    if ( std::string::_Grow(this, v9, 0) )
    {
      v6 = (void *)(_Roff + unknown_libname_11(_Right));
      v4 = unknown_libname_11(this);
      std::char_traits<char>::copy((void *)(*((_DWORD *)this + 5) + v4), v6, _Count);
...
void __cdecl endes(char *inblock, char *outblock)
{
  ...
  char outblocka[116]; // [esp+Ch] [ebp-98h] BYREF
  char v5; // [esp+8Ch] [ebp-18h]
  char v6; // [esp+8Dh] [ebp-17h]
  char v7; // [esp+8Eh] [ebp-16h]
  char v8; // [esp+8Fh] [ebp-15h]
  char v9[8]; // [esp+90h] [ebp-14h] BYREF
  char **v10; // [esp+9Ch] [ebp-8h]
...
{
  unsigned __int8 v2; // [esp+0h] [ebp-20h]
  ...
  v3 = in48[4];
  v5 = in48[5];
  *out32 = byte_43EB50[((v6 >> 4) & 0xF | (unsigned __int16)(16 * *in48)) & 0xFFF];
  out32[1] = byte_43FB50[(v2 | (unsigned __int16)((_WORD)v6 << 8)) & 0xFFF];
  out32[2] = byte_440B50[((v3 >> 4) & 0xF | (unsigned __int16)(16 * v4)) & 0xFFF];
  out32[3] = byte_441B50[(v5 | (unsigned __int16)((_WORD)v3 << 8)) & 0xFFF];
}
...
void __usercall GenerateExceptionReport(DWORD a1@<ebx>, DWORD a2@<edi>, DWORD a3@<esi>, _EXCEPTION_POINTERS *data)
{
  ...
  _DWORD v30[12]; // [esp+9E0h] [ebp-190h] BYREF
    ...
    *(_DWORD *)&SystemTime.wMinute = 0;
    ...
    if ( SymInitialize(v5, 0, 1) )
    {
      ...
      for ( i = 0; i < nThread; ++i )
      {
        ...
        ImageHelpStackWalk(hFile, hThread[i]);
      }
      RecordModuleList(hFile);
...
void __thiscall CIOSocket::CIOTimerInstance::OnTimerCallback(CIOSocket::CIOTimerInstance *this, int nId)
{
  ...
  std::priority_queue<CIOSocket::CIOTimer>::push((std::priority_queue<CIOSocket::CIOTimer> *)&g_timerQueue, v3);
...
unsigned int __stdcall CIOBuffer::FreeAll(void *formal)
{
  ...
  while ( 1 )
  {
    ...
    if ( (int)(g_dwTopTime - v8) <= 0 )
    {
      ...
      for ( i = v4[2]; ; i = v4[2] )
      {
        std::priority_queue<CIOSocket::CIOTimer>::pop((std::priority_queue<CIOSocket::CIOTimer> *)&g_timerQueue);
...
void __thiscall std::priority_queue<CIOSocket::CIOTimer>::push(std::priority_queue<CIOSocket::CIOTimer> *this, const CIOSocket::CIOTimer *_Pred)
{
  ...
  std::vector<CIOSocket::CIOTimer>::push_back((int)this, (int)_Pred);
  v3 = *(_DWORD *)std::vector<CIOSocket::CIOTimer>::end(this, (int)v6);
  v2 = (int *)std::vector<CSyncPacket::CElement>::begin((int *)this, v5);
...
void __thiscall std::priority_queue<CIOSocket::CIOTimer>::pop(std::priority_queue<CIOSocket::CIOTimer> *this)
{
  ...
  v2 = *(_DWORD *)std::vector<CIOSocket::CIOTimer>::end(this, (int)v5);
  v1 = (int *)std::vector<CSyncPacket::CElement>::begin((int *)this, v4);
  std::pop_heap<std::vector<CIOSocket::CIOTimer>::iterator,std::less<CIOSocket::CIOTimer>>(*v1, v2);
...
CIOSocket::CIOTimer *__thiscall std::vector<CIOSocket::CIOTimer>::front(std::vector<CIOSocket::CIOTimer> *this)
{
  ...
  v1 = std::vector<CSyncPacket::CElement>::begin((int *)this, v3);
  return (CIOSocket::CIOTimer *)std::vector<CSyncPacket::CElement>::iterator::operator*(v1);
}
...
int __thiscall std::vector<CIOSocket::CIOTimer>::push_back(int this, int a2)
{
  ...
  {
    result = std::vector<CIOSocket::CIOTimer>::_Xlen((void *)this, *(void **)(this + 8), 1, a2);
...
void __thiscall std::vector<CIOSocket::CIOTimer>::pop_back(std::vector<CIOSocket::CIOTimer> *this)
{
  ...
  {
    std::vector<CIOSocket::CIOTimer>::_Destroy(this, *((_DWORD *)this + 2) - 12, *((_DWORD *)this + 2));
    *((_DWORD *)this + 2) -= 12;
  }
}
...
void __thiscall std::vector<CIOSocket::CIOTimer>::_Insert_n(_DWORD *this, int a2, unsigned int a3, int *a4)
{
  ...
  void *v9; // eax
  void *v10; // eax
  _DWORD v11[4]; // [esp+0h] [ebp-48h] BYREF
  void *v12; // [esp+10h] [ebp-38h]
  unsigned int v13; // [esp+14h] [ebp-34h]
  std::vector<CIOSocket::CIOTimer> *v14; // [esp+18h] [ebp-30h]
  int v15; // [esp+1Ch] [ebp-2Ch]
  void *v16; // [esp+20h] [ebp-28h]
  void *v17; // [esp+24h] [ebp-24h]
  unsigned int v18; // [esp+28h] [ebp-20h]
  CIOSocket::CIOTimer v19; // [esp+2Ch] [ebp-1Ch] BYREF
  _DWORD *v20; // [esp+38h] [ebp-10h]
  int v21; // [esp+44h] [ebp-4h]
  int v22; // [esp+54h] [ebp+Ch]

  v20 = v11;
  v14 = (std::vector<CIOSocket::CIOTimer> *)this;
  v19.m_dwTime = *a4;
  v19.m_pObject = (CIOObject *)a4[1];
  v19.m_nId = a4[2];
  v18 = std::vector<CIOSocket::CIOTimer>::capacity((std::vector<CIOSocket::CIOTimer> *)this);
  if ( a3 )
  {
    v4 = std::vector<CIOSocket::CIOTimer>::size(v14);
    if ( std::priority_queue<CIOSocket::CIOTimer>::empty(v14) - v4 < a3 )
      std::vector<CIOSocket::CIOTimer>::_Xlen();
    v5 = std::vector<CIOSocket::CIOTimer>::size(v14);
    if ( v18 >= a3 + v5 )
    {
      if ( (*((_DWORD *)v14 + 2) - a2) / 12 >= a3 )
      {
        v15 = *((_DWORD *)v14 + 2);
        v10 = std::vector<CIOSocket::CIOTimer>::_Ucopy<CIOSocket::CIOTimer *>(
                v14,
                v15 - 12 * a3,
                v15,
                *((void **)v14 + 2));
        *((_DWORD *)v14 + 2) = v10;
        std::copy_backward<CIOSocket::CIOTimer *,CIOSocket::CIOTimer *>(a2, v15 - 12 * a3, v15);
        std::fill<CIOSocket::CIOTimer *,CIOSocket::CIOTimer>(
          (CIOSocket::CIOTimer *)a2,
          (CIOSocket::CIOTimer *)(a2 + 12 * a3),
          &v19);
      }
      else
      {
        ...
        std::vector<CIOSocket::CIOTimer>::_Xlen(
          v14,
          *((void **)v14 + 2),
          a3 - (*((_DWORD *)v14 + 2) - a2) / 12,
          (int)&v19);
        v21 = -1;
        *((_DWORD *)v14 + 2) += 12 * a3;
        std::fill<CIOSocket::CIOTimer *,CIOSocket::CIOTimer>(
          (CIOSocket::CIOTimer *)a2,
          (CIOSocket::CIOTimer *)(*((_DWORD *)v14 + 2) - 12 * a3),
          &v19);
      }
    }
    else
    {
      v6 = v18 >> 1;
      v7 = std::priority_queue<CIOSocket::CIOTimer>::empty(v14);
      if ( v7 - v6 >= v18 )
        v13 = v18 + (v18 >> 1);
      else
        v13 = 0;
      v18 = v13;
      v8 = std::vector<CIOSocket::CIOTimer>::size(v14);
      if ( v18 < a3 + v8 )
        v18 = a3 + std::vector<CIOSocket::CIOTimer>::size(v14);
      v16 = std::allocator<CIOSocket::CIOTimer>::allocate(v18);
      v17 = v16;
      v21 = 0;
      v12 = std::vector<CIOSocket::CIOTimer>::_Ucopy<CIOSocket::CIOTimer *>(v14, *((_DWORD *)v14 + 1), a2, v16);
      v17 = v12;
      std::vector<CIOSocket::CIOTimer>::_Xlen(v14, v12, a3, (int)&v19);
      v11[3] = v9;
      v17 = v9;
      std::vector<CIOSocket::CIOTimer>::_Ucopy<CIOSocket::CIOTimer *>(v14, a2, *((_DWORD *)v14 + 2), v9);
      v21 = -1;
      v22 = a3 + std::vector<CIOSocket::CIOTimer>::size(v14);
      if ( *((_DWORD *)v14 + 1) )
      {
        std::vector<CIOSocket::CIOTimer>::_Destroy(v14, *((_DWORD *)v14 + 1), *((_DWORD *)v14 + 2));
        std::allocator<CSyncPacket::CElement>::deallocate(
          *((_DWORD *)v14 + 1),
          (*((_DWORD *)v14 + 3) - *((_DWORD *)v14 + 1)) / 12);
      }
      *((_DWORD *)v14 + 3) = (char *)v16 + 12 * v18;
      *((_DWORD *)v14 + 2) = (char *)v16 + 12 * v22;
      *((_DWORD *)v14 + 1) = v16;
    }
  }
}
// 40C9F5: variable 'v9' is possibly undefined

//----- (0040CC10) --------------------------------------------------------
int __thiscall std::priority_queue<CIOSocket::CIOTimer>::empty(void *this)
{
  return std::allocator<std::pair<unsigned int const,TriggerSystem::CTrigger::ACTION_INFO>>::max_size();
}
...
_DWORD *__cdecl std::push_heap<std::vector<CIOSocket::CIOTimer>::iterator,std::less<CIOSocket::CIOTimer>>(int a1, int a2)
{
  ...
  result = (_DWORD *)std::_Tree<std::_Tmap_traits<int,CUser *,std::less<int>,std::allocator<std::pair<int const,CUser *>>,0>>::const_iterator::operator!=(
                       (std::vector<CIOSocket::CIOTimer>::const_iterator *)&a1,
                       (const std::vector<CIOSocket::CIOTimer>::const_iterator *)&a2);
  if ( (_BYTE)result )
  {
...
{
  unknown_libname_15(&a1, &a1);
  return std::_Construct<CIOSocket::CIOTimer,CIOSocket::CIOTimer>(a1, a2, a3);
}
// 404F10: using guessed type int __cdecl unknown_libname_15(_DWORD, _DWORD);
...
BOOL __thiscall std::_Tree<std::_Tmap_traits<int,CUser *,std::less<int>,std::allocator<std::pair<int const,CUser *>>,0>>::const_iterator::operator!=(std::vector<CIOSocket::CIOTimer>::const_iterator *this, const std::vector<CIOSocket::CIOTimer>::const_iterator *_Right)
{
  return (unsigned __int8)unknown_libname_18(_Right) == 0;
}
// 405110: using guessed type _DWORD __stdcall unknown_libname_18(_DWORD);
...
_DWORD *__cdecl std::_Push_heap_0<std::vector<CIOSocket::CIOTimer>::iterator,int,CIOSocket::CIOTimer,std::less<CIOSocket::CIOTimer>>(int a1, int a2)
{
  ...
  result = (_DWORD *)std::vector<CIOSocket::CIOTimer>::iterator::operator-(&a2, (int)&a1);
  v4 = (int)result;
  if ( (int)result > 0 )
  {
...
void __cdecl std::_Construct<CIOSocket::CIOTimer,CIOSocket::CIOTimer>(CIOSocket::CIOTimer *_Ptr, const CIOSocket::CIOTimer *_Val, int a3)
{
  ...
  while ( _Val )
  {
    std::allocator<CIOSocket::CIOTimer>::construct(_Ptr, a3);
    _Val = (const CIOSocket::CIOTimer *)((char *)_Val - 1);
    ++_Ptr;
  }
}
...
{
  unknown_libname_15(&a1, &a3);
  return CIOSocket::CIOTimerInstance::CIOTimerInstance(a1, a2, a3);
}
// 404F10: using guessed type int __cdecl unknown_libname_15(_DWORD, _DWORD);
...
_DWORD *__thiscall std::vector<CIOSocket::CIOTimer>::iterator::operator-=(_DWORD *this, int a2)
{
  return std::_Destroy_range<CIOSocket::CIOTimer>(this, -a2);
}
...
_DWORD *__cdecl std::_Push_heap<std::vector<CIOSocket::CIOTimer>::iterator,int,CIOSocket::CIOTimer,std::less<CIOSocket::CIOTimer>>(int a1, int a2, int a3, int a4, int a5, int a6)
{
  ...
  result = (_DWORD *)std::vector<CSyncPacket::CElement>::iterator::operator*(v12);
  *result = a4;
  result[1] = a5;
  result[2] = a6;
  return result;
...
char __thiscall std::vector<CIOSocket::CIOTimer>::_Buy(std::vector<CIOSocket::CIOTimer> *this, unsigned int _Capacity)
{
  ...
  *((_DWORD *)this + 3) = 0;
  if ( !_Capacity )
    return 0;
  if ( std::priority_queue<CIOSocket::CIOTimer>::empty(this) < _Capacity )
    std::vector<CIOSocket::CIOTimer>::_Xlen();
  *((_DWORD *)this + 1) = std::allocator<CIOSocket::CIOTimer>::allocate(_Capacity);
  *((_DWORD *)this + 2) = *((_DWORD *)this + 1);
...
//----- (0040D7F0) --------------------------------------------------------
void __thiscall std::vector<CSyncPacket::CElement>::_Tidy(std::vector<CIOSocket::CIOTimer> *this)
{
  if ( *((_DWORD *)this + 1) )
  {
    std::vector<CIOSocket::CIOTimer>::_Destroy(this, *((_DWORD *)this + 1), *((_DWORD *)this + 2));
    std::allocator<CSyncPacket::CElement>::deallocate(
      *((_DWORD *)this + 1),
      (*((_DWORD *)this + 3) - *((_DWORD *)this + 1)) / 12);
  }
  *((_DWORD *)this + 1) = 0;
  *((_DWORD *)this + 2) = 0;
  *((_DWORD *)this + 3) = 0;
...
void __cdecl CLog::AddV(int nType, char *format, char *va)
{
  ...
  CLink::Insert((CScreen *)&CScreen::s_pScreen, color[nType], Source);
  if ( nType >= 1 )
  {
    time(&Time);
    Tm = localtime(&Time);
...
void __thiscall CServer::CreateSocket(CServer *this)
{
  if ( InterlockedCompareExchange(&this->m_nRef, 1, 0) )
...
void CServer::Start()
{
  CIOObject::Release((CIOServer *)(&stru_4441A4 + 7), *(int *)&nPort);
...
void __stdcall CServer::Shutdown()
{
  ...
  while ( 1 )
  {
    ...
    CIOSpinLock::Leave((CIOSpinLock *)&stru_4441A4 + 6);
    CIOSocket::WriteCallback((CIOSocket *)(v0 - 108));
...
void __thiscall CSyncPacket::OnIOCallback(CSyncPacket *this, int bSuccess, unsigned int dwTransferred, _OVERLAPPED *lpOverlapped)
{
  ...
  do
  {
    ...
    if ( !std::_Tree<std::_Tmap_traits<int,CUser *,std::less<int>,std::allocator<std::pair<int const,CUser *>>,0>>::const_iterator::operator!=(
            (CSyncPacket *)((char *)this + 32),
            (CSyncPacket *)((char *)this + 36)) )
      EBREAK();
...
void __thiscall CSocket::OnCreate(CSocket *this)
{
  ...
  if ( !std::vector<IPAddrMask>::empty(CDBConfig::s_vSubNet) )
  {
    ...
    while ( 1 )
    {
      v2 = (const std::vector<CIOSocket::CIOTimer>::const_iterator *)std::vector<CIOSocket::CIOTimer>::end(
                                                                       CDBConfig::s_vSubNet,
                                                                       (int)v8);
      if ( !std::_Tree<std::_Tmap_traits<int,CUser *,std::less<int>,std::allocator<std::pair<int const,CUser *>>,0>>::const_iterator::operator!=(
...
void CSocket::Write(CSocket *this, D2S_PROTOCOL nType, const char *formal, ...)
{
  ...
  v3 = CIOBuffer::Alloc();
  v3->m_buffer[2] = nType;
  *(_WORD *)v3->m_buffer = (unsigned __int16)WritePacket(&v3->m_buffer[3], (char *)&formal) - (_WORD)v3;
...
void __thiscall CSocket::Process(CSocket *this, DBPACKET *dbpacket)
{
  ...
  switch ( v242 )
  {
    ...
    case 18:
      ...
      CSyncPacket::CElement::CElement(this, v169, v167, v168);
      break;
    case 19:
    ...
    case 21:
      ...
      CSyncPacket::CElement::CElement((CSyncPacket::CElement *)this, v157, v155, v154, v156, (char *)Src);
      break;
    case 22:
    ...
    case 35:
      ReadPacket(
        ...
        &v127,
        &v129);
      init_codepage(v130, v132, v123, v126, v124, v125, v122, v128, TargetValue, v129, v127);
      break;
    case 36:
    ...
    case 38:
      ...
      InitCodePage::InitCodePage(this, nId, v117, (char *)Src);
      break;
    case 39:
      Src = ReadPacket((char *)Src, "db", &v114, &v115);
      operator new[](this, v114, v115, (const char *)Src);
      break;
    case 40:
...
void __thiscall CSocket::LoadPlayer(CSocket *this, int nPID, int nLoadGID, int nUID, int nId)
{
  ...
  char str[4]; // [esp+8Ch] [ebp-5Ch] BYREF
  ...
  *((_BYTE *)Src + 2) = 4;
  ...
  CDB::Bind(&v66, &n);
  CDB::Skip(&v66);
  CDB::Bind((int)&v66, &TargetValue);
  CDB::Bind(&v66, str, 17);
  CDB::Bind((int)&v66, &v52);
  CDB::Bind((int)&v66, &v68);
  CDB::Bind((int)&v66, &v45);
  CDB::Bind(&v66, (unsigned __int16 *)v54);
  CDB::Bind(&v66, &v62);
  CDB::Bind(&v66, &v39);
  CDB::Bind((int)&v66, &v51);
  CDB::Bind((int)&v66, &v63);
  CDB::Bind((int)&v66, &v57);
  CDB::Bind((int)&v66, &v55);
  CDB::Bind((int)&v66, &v37);
  CDB::Bind((int)&v66, &v38);
  CDB::Bind(&v66, &v46);
  CDB::Bind(&v66, &v40);
  CDB::Bind(&v66, &v47);
  CDB::Bind(&v66, (unsigned __int16 *)v48);
  CDB::Bind((int)&v66, &v69);
  CDB::Bind((int)&v66, &v53);
  CDB::Bind(&v66, &v61);
  CDB::Bind(&v66, &v41);
  CDB::Bind(&v66, &v43);
  CDB::Bind((int)&v66, &v58);
  CDB::Bind((int)&v66, &v49);
  CDB::Bind((int)&v66, &v64);
  CDB::Bind(&v66, &v50);
      ...
      if ( nUID == n )
      {
        ...
        if ( TargetValue != 1 )
        {
          ...
          *v8 = 0;
          ...
          CDB::Bind(&v66, &v34);
          CDB::Bind(&v66, &v11);
          CDB::Bind((int)&v66, &v22);
          CDB::Bind(&v66, &v16);
          CDB::Bind(&v66, &v17);
          CDB::Bind((int)&v66, &v18);
          CDB::Bind((int)&v66, &v24);
          CDB::Bind((int)&v66, &v29);
          CDB::Bind((int)&v66, &v19);
          CDB::Bind((int)&v66, &v13);
          CDB::Bind((int)&v66, &v25);
          CDB::Bind((int)&v66, &v26);
          CDB::Bind((int)&v66, &v14);
          CDB::Bind((int)&v66, &v36);
          CDB::Bind((int)&v66, &v30);
          CDB::Bind((int)&v66, &v15);
          ...
          *v8 = 0;
          ...
          CDB::Skip(&v66);
          CDB::Bind(&v66, &v31);
          CDB::Bind((int)&v66, &v12);
          CDB::Bind((int)&v66, &v33);
          ...
          *v8 = 0;
          CDB::Reset(&v66);
          CDB::Bind((int)&v66, &v20);
          CDB::Bind(&v66, str, 17);
          CDB::Bind(&v66, &v28);
          CDB::Bind(&v66, &v32);
          CDB::Bind((int)&v66, &v27);
          CDB::Bind((int)&v66, &v21);
          if ( CDB::Execute(
                 &v66,
...
void __thiscall CSocket::UpdateItemXValue(CSocket *this, int nIID, int nPID, int nPrtyType, int nXValue)
{
  ...
  {
    case 9:
      CDB::Execute(&v6, "UPDATE Item SET [XHit] = %d WHERE [IID] = %d", nXValue, nIID);
      goto LABEL_7;
    case 10:
      CDB::Execute(&v6, "UPDATE Item SET [XDodge] = %d WHERE [IID] = %d", nXValue, nIID);
      goto LABEL_7;
    case 15:
      CDB::Execute(&v6, "UPDATE Item SET [XDefense] = %d WHERE [IID] = %d", nXValue, nIID);
      goto LABEL_7;
    case 27:
      CDB::Execute(&v6, "UPDATE Item SET [XAttack] = %d WHERE [IID] = %d", nXValue, nIID);
      goto LABEL_7;
    case 28:
      CDB::Execute(&v6, "UPDATE Item SET [XMagic] = %d WHERE [IID] = %d", nXValue, nIID);
LABEL_7:
      LOG_DB(9, 21, nPID, 0, nIID, nPrtyType, nXValue, 0, 0);
      if ( v8 )
        CSyncPacket::CElement::CElement((CSyncPacket::CElement *)this, nIID, nPID, 64, 0, (char *)&nPrtyType);
      break;
    default:
      break;
  }
...
void __thiscall CSocket::UpdateItemPrefix(CSocket *this, int nIID, int nPID, int nNewPrefix)
{
  ...
  CDB::CDB(&v6);
  v7 = 0;
  CDB::Execute(&v6, "UPDATE Item SET [Prefix] = %d WHERE [IID] = %d", nNewPrefix, nIID);
  LOG_DB(9, 27, nPID, 0, nIID, nNewPrefix, 0, 0, 0);
  if ( v8 )
  {
    Src = 255;
    CSyncPacket::CElement::CElement((CSyncPacket::CElement *)this, nIID, nPID, 64, 0, (char *)&Src);
  }
  v7 = -1;
  CDB::~CDB(&v6);
}
...
void __thiscall CSyncPacket::CElement::CElement(CSyncPacket::CElement *this, int nIID, int nID1, int nVal1, int a5, char *Src)
{
  unsigned __int8 v6; // [esp+7h] [ebp-2Dh] BYREF
  unsigned __int16 v7; // [esp+8h] [ebp-2Ch] BYREF
  int nVal3; // [esp+Ch] [ebp-28h] BYREF
  int nVal4; // [esp+10h] [ebp-24h] BYREF
  unsigned __int8 v10; // [esp+17h] [ebp-1Dh] BYREF
  CDB v11; // [esp+18h] [ebp-1Ch] BYREF
  ...
  if ( a5 )
  {
    ReadPacket(Src, "wddb", &v7, &nVal3, &nVal4, &v10);
    CDB::Execute(&v11, "UPDATE Item SET [Info] = [Info] | %d WHERE [IID] = %d", nVal1, nIID);
    if ( ((nVal1 & 0x40) == 0 || !v10) && (nVal1 & 0x7FF00) == 0 )
      LOG_ERR("CSocket::UpdateItemInfo() Protect Number Error (PID:%d, IID:%d, Info:%d)", nID1, nIID, nVal1);
    if ( (nVal1 & 0x40) != 0 )
    {
      CDB::Reset(&v11);
      CDB::Execute(&v11, "UPDATE Item SET [Protect] = %d WHERE [IID] = %d", v10, nIID);
    }
    LOG_DB(9, 44, nID1, 1, nIID, nVal1, v7, nVal3, nVal4);
  }
  else
  {
    ReadPacket(Src, "b", &v6);
    CDB::Execute(&v11, "UPDATE Item SET [Info] = [Info] & %d WHERE [IID] = %d", ~nVal1, nIID);
    LOG_DB(9, 44, nID1, 0, nIID, nVal1, v6, 0, 0);
  }
  v12 = -1;
  CDB::~CDB(&v11);
}
...
void __thiscall sub_415790(void *this, int a2, int a3, void *Src)
{
  ...
  switch ( a2 )
  {
    case 0:
      ...
      if ( CDB::Execute(&v105, " SELECT [PID] FROM Player WHERE [Name] = '%s'", v97) && CDB::Fetch(&v105) )
      {
        ...
        else
        {
          ...
          pcbValue = strlen(Str);
          CDB::Reset(&v105);
          CDB::BindParam(&v105.m_hStmt, 1u, 1, -2, -3, 0x200u, 0, Str, 512, &pcbValue);
          CDB::Execute(
            &v105,
    ...
    case 4:
      ...
      CDB::Reset(&v105);
      StrLen_or_Ind = 0;
      CDB::BindCol((int)&v105, -2, v50, 512, &StrLen_or_Ind);
...
void __thiscall CSocket::Login(void *this, int a2, int a3)
{
  ...
  char str[2]; // [esp+74h] [ebp-4Ch] BYREF
      ...
      else
      {
        ...
        else
        {
          ...
          if ( v28 == 5 )
          {
            ...
            v12 = v2->bottom;
            ++g_nCreate;
            v17 = RandomBetween(v9, v11);
            v18 = RandomBetween(v10, v12);
...
void __stdcall init_codepage(unsigned int codepage, int nIID, int nVal1, int nVal2, char a5, int nVal3, int a7, int nVal4, int TargetValue, int a10, int nID2)
{
  ...
  CDB::Execute(
    ...
    a7,
    nVal4);
  LOG_DB(5, codepage, TargetValue, nID2, nIID, nVal1, nVal2, nVal3, nVal4);
  v12 = -1;
  CDB::~CDB(&v11);
}
...
void __thiscall sub_41A450(void *this, int a2, int a3, void *Src)
{
  ...
  if ( a2 )
  {
    ...
    StrLen_or_Ind = 40;
    CDB::BindParam(&v8.m_hStmt, 1u, 1, -2, -3, 0x28u, 0, TargetValue, 40, &StrLen_or_Ind);
  ...
  else
  {
    ...
    CDB::BindCol((int)&v8, -2, TargetValue, 40, &StrLen_or_Ind);
...
{
  ++this->m_nBind;
  SQLBindCol(this->m_hStmt, this->m_nBind, nType, pValue, nLength, pnInd);
}

//----- (0041B310) --------------------------------------------------------
void __thiscall CDB::BindParam(CDB *this, unsigned __int16 ipar, __int16 fParamType, __int16 fCType, __int16 fSqlType, unsigned int cbColDef, __int16 ibScale, void *rgbValue, int cbValueMax, int *pcbValue)
{
  SQLBindParameter(this->m_hStmt, ipar, fParamType, fCType, fSqlType, cbColDef, ibScale, rgbValue, cbValueMax, pcbValue);
}
...
BOOL __thiscall std::vector<IPAddrMask>::empty(_DWORD *this)
{
  return std::vector<XMessageQueue::XElement>::size(this) == 0;
}
...
{
  CIOSpinLock::Enter((CIOSpinLock *)&dword_448DE4);
  *((_DWORD *)pT + 4) = CMemoryPool<CPacket>::s_pool;
  CMemoryPool<CPacket>::s_pool = (int)pT;
  CIOSpinLock::Leave((CIOSpinLock *)&dword_448DE4);
}
// 448DE0: using guessed type int CMemoryPool<CPacket>::s_pool;
...
_DWORD *__thiscall std::vector<CSyncPacket::CElement>::iterator::operator+(int *this, _DWORD *a1, int a2)
{
  ...
  v4 = *this;
  *a1 = *std::vector<tagRECT>::iterator::operator+=(&v4, a2);
  return a1;
}
...
void __thiscall std::vector<CSyncPacket::CElement>::_Insert_n(void *this, tagRECT *a2, unsigned int a3, LONG *a4)
{
  ...
  tagRECT *v11; // [esp+Ch] [ebp-44h]
  tagRECT *v12; // [esp+10h] [ebp-40h]
  unsigned int v13; // [esp+14h] [ebp-3Ch]
  void *v14; // [esp+18h] [ebp-38h]
  int v15; // [esp+1Ch] [ebp-34h]
  void *v16; // [esp+20h] [ebp-30h]
  void *v17; // [esp+24h] [ebp-2Ch]
  unsigned int v18; // [esp+28h] [ebp-28h]
  tagRECT v19; // [esp+2Ch] [ebp-24h] BYREF
  ...
  v19.right = a4[2];
  v19.bottom = a4[3];
  v18 = std::vector<tagRECT>::capacity((std::vector<tagRECT> *)this);
  if ( a3 )
  {
    v4 = std::vector<tagRECT>::size((std::vector<tagRECT> *)v14);
    if ( std::vector<CSyncPacket::CElement>::max_size(v14) - v4 < a3 )
      std::vector<CSyncPacket::CElement>::_Xlen();
    v5 = std::vector<tagRECT>::size((std::vector<tagRECT> *)v14);
    if ( v18 >= a3 + v5 )
    {
      if ( (*((_DWORD *)v14 + 2) - (int)a2) >> 4 >= a3 )
      {
        v15 = *((_DWORD *)v14 + 2);
        v9 = std::vector<CSyncPacket::CElement>::_Ucopy<CSyncPacket::CElement *>(
               ...
               *((void **)v14 + 2));
        *((_DWORD *)v14 + 2) = v9;
        std::copy_backward<CSyncPacket::CElement *,CSyncPacket::CElement *>((int)a2, v15 - 16 * a3, v15);
        std::fill<tagRECT *,tagRECT>(a2, &a2[a3], &v19);
      }
      else
      {
        std::vector<CSyncPacket::CElement>::_Ucopy<CSyncPacket::CElement *>(v14, (int)a2, *((_DWORD *)v14 + 2), &a2[a3]);
        v21 = 2;
        std::vector<tagRECT>::_Ufill(
          (std::vector<tagRECT> *)v14,
          *((tagRECT **)v14 + 2),
          a3 - ((*((_DWORD *)v14 + 2) - (int)a2) >> 4),
          &v19);
        v21 = -1;
        *((_DWORD *)v14 + 2) += 16 * a3;
        std::fill<tagRECT *,tagRECT>(a2, (tagRECT *)(*((_DWORD *)v14 + 2) - 16 * a3), &v19);
      }
    }
    else
    {
      v6 = v18 >> 1;
      v7 = std::vector<CSyncPacket::CElement>::max_size(v14);
      if ( v7 - v6 >= v18 )
        v13 = v18 + (v18 >> 1);
      else
        v13 = 0;
      v18 = v13;
      v8 = std::vector<tagRECT>::size((std::vector<tagRECT> *)v14);
      if ( v18 < a3 + v8 )
        v18 = a3 + std::vector<tagRECT>::size((std::vector<tagRECT> *)v14);
      v16 = std::allocator<CSyncPacket::CElement>::allocate(v18);
      v17 = v16;
      v21 = 0;
      v12 = (tagRECT *)std::vector<CSyncPacket::CElement>::_Ucopy<CSyncPacket::CElement *>(
                         v14,
                         *((_DWORD *)v14 + 1),
                         (int)a2,
                         v16);
      v17 = v12;
      v11 = std::vector<tagRECT>::_Ufill((std::vector<tagRECT> *)v14, v12, a3, &v19);
      v17 = v11;
      std::vector<CSyncPacket::CElement>::_Ucopy<CSyncPacket::CElement *>(v14, (int)a2, *((_DWORD *)v14 + 2), v11);
      v21 = -1;
      v22 = a3 + std::vector<tagRECT>::size((std::vector<tagRECT> *)v14);
      if ( *((_DWORD *)v14 + 1) )
      {
        std::vector<CSyncPacket::CElement>::_Destroy(v14, *((_DWORD *)v14 + 1), *((_DWORD *)v14 + 2));
        std::allocator<CSyncPacket::CElement>::deallocate(
          *((_DWORD *)v14 + 1),
          (*((_DWORD *)v14 + 3) - *((_DWORD *)v14 + 1)) >> 4);
      }
      *((_DWORD *)v14 + 3) = (char *)v16 + 16 * v18;
      *((_DWORD *)v14 + 2) = (char *)v16 + 16 * v22;
      *((_DWORD *)v14 + 1) = v16;
    }
  }
}
...
int __thiscall std::vector<CSyncPacket::CElement>::max_size(void *this)
{
  return std::allocator<tagRECT>::max_size();
}
...
//----- (0041BCD0) --------------------------------------------------------
void __cdecl std::fill<tagRECT *,tagRECT>(tagRECT *_First, tagRECT *_Last, const tagRECT *_Val)
{
  while ( _First != _Last )
    *_First++ = *_Val;
}
...
{
  unknown_libname_15(&a1, &a3);
  return std::_Copy_backward_opt<tagRECT *,tagRECT *>((_DWORD *)a1, (_DWORD *)a2, (_DWORD *)a3);
}
// 404F10: using guessed type int __cdecl unknown_libname_15(_DWORD, _DWORD);
...
void __cdecl std::_Uninit_fill_n<CSyncPacket::CElement *,unsigned int,CSyncPacket::CElement,std::allocator<CSyncPacket::CElement>>(CSyncPacket::CElement *_First, unsigned int _Count, const CSyncPacket::CElement *_Val)
{
  DOUBLE tmp; // [esp+0h] [ebp-20h] BYREF
  CSyncPacket::CElement *v4; // [esp+Ch] [ebp-14h]
  ...
  while ( _Count )
  {
    std::allocator<CSyncPacket::CElement>::construct(_First, (int)_Val);
    --_Count;
    ++_First;
  }
}
...
_DWORD *__stdcall std::allocator<CSyncPacket::CElement>::construct(void *a1, int a2)
{
  return std::_Construct<tagRECT,tagRECT>(a1, a2);
}
...
CSyncPacket::CElement *__cdecl std::_Uninit_copy<CSyncPacket::CElement *,CSyncPacket::CElement *,std::allocator<CSyncPacket::CElement>>(CSyncPacket::CElement *_First, CSyncPacket::CElement *_Last, CSyncPacket::CElement *_Dest)
{
  ...
  v4[7] = 0;
  while ( _First != _Last )
    std::allocator<CSyncPacket::CElement>::construct(_Dest++, (int)_First++);
  return _Dest;
}

//----- (0041C010) --------------------------------------------------------
void __cdecl std::_Construct<tagRECT,tagRECT>(tagRECT *_Ptr, const tagRECT *_Val)
{
  tagRECT *v2; // [esp+4h] [ebp-4h]

  v2 = (tagRECT *)operator new(0x10u, _Ptr);
  if ( v2 )
    *v2 = *_Val;
}
...
int *__thiscall std::vector<CSyncPacket::CElement>::~vector<CSyncPacket::CElement>(void *this)
{
  return std::vector<tagRECT>::_Tidy((int *)this);
}
...
char __thiscall std::vector<tagRECT>::_Buy(std::vector<tagRECT> *this, unsigned int _Capacity)
{
  ...
  *((_DWORD *)this + 3) = 0;
  ...
  if ( std::vector<CSyncPacket::CElement>::max_size(this) < _Capacity )
    std::vector<CSyncPacket::CElement>::_Xlen();
  *((_DWORD *)this + 1) = std::allocator<CSyncPacket::CElement>::allocate(_Capacity);
  *((_DWORD *)this + 2) = *((_DWORD *)this + 1);
...
//----- (0041C2B0) --------------------------------------------------------
void __thiscall std::vector<tagRECT>::_Tidy(std::vector<tagRECT> *this)
{
  if ( *((_DWORD *)this + 1) )
  {
    std::vector<CSyncPacket::CElement>::_Destroy(this, *((_DWORD *)this + 1), *((_DWORD *)this + 2));
    std::allocator<CSyncPacket::CElement>::deallocate(
      *((_DWORD *)this + 1),
      (*((_DWORD *)this + 3) - *((_DWORD *)this + 1)) >> 4);
  }
  *((_DWORD *)this + 1) = 0;
  *((_DWORD *)this + 2) = 0;
  *((_DWORD *)this + 3) = 0;
...
void __thiscall CMemoryPool<CPacket>::CPool::~CPool(void *this)
{
  CMemoryPool<CBillingPacket>::FreeAll();
}
...
void __cdecl LogPacket(int nType, int nSize, char *buffer)
{
  ...
  char v6[104]; // [esp+10h] [ebp-78h] BYREF
...
std::string *__cdecl GetUniqueName(std::string *result)
{
  ...
  std::string::string(result, Filename);
  return result;
}
